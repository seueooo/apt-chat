...
export function Dashboard() {
	...
	return (
		<div className="flex min-h-screen flex-col p-4 md:h-screen md:flex-row md:p-6">
			{/* Simulator Panel */}
			<section className="flex flex-1 flex-col gap-6 border-b border-border-default p-6 md:min-h-0 md:overflow-y-auto md:border-r md:border-b-0">
